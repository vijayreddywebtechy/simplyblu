...
import { cityOptions, provinceOptions, yesNoOptions } from "@/lib/data";
  ...
  return (
    <>
      <div className="p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-5 gap-x-12">
          ...
          <div>
            ...
            <RHFInput type="email" name="email" placeholder="Force@gmail.com" />
          </div>
      ...
      <div className="p-4">
        ...
        <RHFRadioGroup name="isPublicOfficial" options={yesNoOptions} />
      </div>
      ...
      <div className="p-4">
        ...
        <RHFRadioGroup name="isSouthAfricaResident" options={yesNoOptions} />
      </div>
      ...
      <div className="p-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-5 gap-x-12">
          <div>
            ...
            <RHFInput placeholder="e.g. 134 Raglan Street" name="street" />
          </div>

          <div>
            <Label className="inline-flex mb-1.5">UNIT NUMBER (OPTIONAL)</Label>
            <RHFInput placeholder="e.g. 12" name="unit" />
          </div>
          ...
          <div>
            ...
            <RHFInput placeholder="e.g. Sandton" name="suburbName" />
          </div>
          ...
          <div>
            ...
            <RHFInput type="number" placeholder="e.g. 2091" name="postalCode" />
          </div>
        </div>
      </div>
