    ...
    <div className="border border-gray-200 rounded-xl overflow-hidden">
      <div className="flex flex-col lg:flex-row gap-x-40">
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <div className="flex items-start gap-2 mt-3 py-3">
                ...
                <p className="text-sm text-gray-light">Rent a card machine and enjoy free maintenance, onsite support, replacements, and upgrades – at no extra cost
            ...
            <div className="space-y-4">
              <RadioGroup value={selectedPaymentSolution} onValueChange={setSelectedPaymentSolution}>
                {paymentSolutions.map((solution) => (
                  <div
                    key={solution.id}
                    className={`border rounded-xl p-4 my-5 cursor-pointer transition-all relative ${
                  ...
                  >
                <div className="absolute -top-3 left-0 min-w-36 bg-primary-dark text-white text-xs px-3 py-0.5 rounded-br-xl">
                  Payment solution
                </div>
                      ...
                      <div className="flex items-start justify-between gap-2 flex-1">
                        {solution.id === "pro" && (
                          <div className="w-24 h-32 rounded flex items-center justify-center flex-shrink-0">
                            <Image src={cardMachineImg} width={96} height={128} alt="Card Machine" className="object-contain" />
                          </div>
                        )}
                        {solution.id === "pocket" && (
                          <div className="w-24 h-32 rounded flex items-center justify-center flex-shrink-0">
                            <Image src={pocketMachineImg} width={96} height={128} alt="Pocket Machine" className="object-contain" />
                          </div>
                        )}
                        {solution.id === "classic" && (
                          <div className="w-24 h-32 rounded flex items-center justify-center flex-shrink-0">
                        ...
                        <div className="flex-1">
                          <h4 className="font-bspro text-base font-medium text-gray-dark mb-2">
                            {solution.label}
                          </h4>
                          ...
                          <div className="flex gap-7">
                            <div>
                              <p className="text-base font-medium text-gray-dark">{solution.rental}</p>
                              <p className="text-xs text-gray-light">{solution.rentalLabel}</p>
                            </div>
                            <div>
                              <p className="text-base font-medium text-gray-dark">{solution.purchase}</p>
              ...
              <div className="border border-gray-300 hover:border-gray-400 rounded-xl p-4 relative">
                <div className="absolute -top-3 left-0 min-w-36 bg-gradient-to-b from-[#FFC700] to-[#FF5C00] text-white text-xs px-3 py-0.5 rounded-br-xl">
                  Added bonus
                </div>
                <div className="flex items-start gap-3 pt-2">
                  <div className="w-24 h-32 rounded flex items-center justify-center flex-shrink-0">
                    <Image src={merchantAppImg} width={52} height={104} alt="Merchant App" className="object-contain" />
                  </div>
                  <div className="flex-1">
        ...
        <div className="lg:w-1/2 w-full p-6">
          <div className="space-y-4">
            {/* Total Fee Card */}
            <div className="bg-gradient-to-b from-[#0033AA] to-[#00164E] text-white rounded-lg p-4 text-center">
                <div className="max-w-64 mx-auto">
              <h3 className="text-xl font-normal text-white">
                Total monthly fee for the card machine(s):
              </h3>
              <div className="flex items-baseline justify-center">
                <sup className="text-xl -top-3">R</sup>
                <span className="text-[42px] mx-1">0.00</span>
            ...
            <div className="bg-white rounded-lg p-6 border border-gray-200">
              <p className="text-sm text-gray-500 text-center mb-4">Placeholder</p>
              
              <div className="space-y-6">
                {/* Monthly Fee */}
                <div className="text-center py-5 border-b border-gray-200">
                  <h4 className="text-base font-medium text-gray-light mb-7">
                    Monthly fee per card machine
                  </h4>
                  <div className="flex items-baseline justify-center">
                    <sup className="text-base text-gray-dark -top-2">R</sup>
                    <span className="text-4xl font-medium text-gray-medium mx-1">0.00</span>
                    <sub className="text-sm text-gray-light">(excl. VAT )</sub>
                  </div>
                </div>
                ...
                <div className="text-center py-5 border-b border-gray-200">
                  ...
                  <div className="flex items-baseline justify-center">
                    <sup className="text-base text-gray-dark -top-2">R</sup>
                    <span className="text-4xl font-medium text-gray-medium mx-1">0.00</span>
                    <sub className="text-sm text-gray-light">(per month/ per card machine)</sub>
                  </div>
                </div>
                ...
                <div className="text-center pt-2">
                  ...
                  <Button className="h-10 md:h-12 uppercase mt-16 hover:bg-primary/90 w-full max-w-72" onClick={onNext}>
                    Continue
                  </Button>
                </div>
              </div>
            ...
            <div className="bg-gray-100 rounded-lg p-6 border border-gray-200">
              ...
              <div className="grid grid-cols-4 gap-2 mb-6">
                {[visacard, mastercard, dinerscard, unionpaycard].map((img, i) => (
                  <div
                    key={i}
                    className="bg-white border border-gray-100 rounded-lg p-2 flex items-center justify-center"
                  >
                    <Image src={img} width={50} height={30} alt="Card" className="object-contain" />
                  </div>
                ))}
              </div>
