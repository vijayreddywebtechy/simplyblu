...
const headingClass =
  "font-bspro text-sm font-medium leading-normal text-gray-dark mb-3";
      ...
      <div className="p-4">
        ...
        <p className={`${textClass} mb-7`}> Our Privacy Statement informs you what personal information is, what
          ...
          <div className="flex items-center gap-3 mb-7">
            <Checkbox id="terms" />
            <Label htmlFor="terms" className="text-sm">I have read and understood the contents of the Privacy Statement</Label>
          </div>
        ...
        <RadioGroup defaultValue="comfortable" className="flex mt-2.5 mb-7 gap-5">
        ...
        <div className="flex items-center gap-2.5 mb-8">
          ...
          <p className="font-bspro text-sm sm:text-base leading-normal text-gray-medium">
